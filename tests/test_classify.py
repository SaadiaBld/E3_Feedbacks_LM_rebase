...
def test_run_calls_dependencies(mock_get_verbatims, mock_classify_claude):
    ...
    #simule get_verbatims_from_bq pour qu’elle retourne 2 verbatims (avis fictifs)
    mock_get_verbatims.return_value = mock_verbatims

    # simule la fonction classify_with_claude pour qu’elle retourne 
    # un résultat de classification (un thème "Test", note 3.0).
